...
public class Quine_Mccluskey {
    ...
    //will convert the final essential pi and pi into switching variables
    ...
    //this will identify the prime implicants with the minterms
    ...
    public static void main(String args[])throws IOException {
        ...
        while(true) {
            ...
            if(count==0)//if in a table there is no term carried forward then we will stop
                break;//distributeRule 0 signifies that no elements are combined to move to next pass so process will terminate
       ...
       /* System.out.println("THE ESSENTIAL PRIME IMPLICANTS ARE (BINARY FORMS):-");
        ...
        while(true) {
            ...
            if(count==0)//if there is no more row or column dominance we will stop
                break;//distributeRule =0 signifies there is no existing column or row dominance so process will terminate
        }
